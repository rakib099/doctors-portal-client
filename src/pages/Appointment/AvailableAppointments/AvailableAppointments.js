...
const AvailableAppointments = ({ selectedDate }) => {
    ...
    const { data:appointmentOptions, refetch, isLoading } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch(`https://doctors-portal-server-two-pi.vercel.app/appointmentOptions?date=${date}`);
    ...
    // useEffect(() => {
    //     fetch('https://doctors-portal-server-two-pi.vercel.app/appointmentOptions')
    //         .then(res => res.json())
    //         .then(data => {
